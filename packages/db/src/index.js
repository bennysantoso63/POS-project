 ...
 * String literal export to ensure compatibility with both Node.js (Electron)
 * and React Native (Expo) without relying on 'fs' module.
 */
const schema = `
-- ==============================================================================
...
CREATE TABLE IF NOT EXISTS users (
    ...
    role TEXT NOT NULL CHECK(role IN ('admin', 'manager', 'cashier', 'auditor', 'owner')),
